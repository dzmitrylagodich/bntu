...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  <table id="admissionTable">
      <tr>
      <th id="programIdHeader">
          ID Программы
      </th>
       <th id="bntuSpecialtyIdHeader">
  ...
  <?php
      $adds = mysqli_query($conn, "SELECT * from `Admission`");
      ...
      <td>
          <a href="../updatefor/updateaddmis.php?ProgramID=<?= $add[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/Addmision/delete.php?ProgramID=<?= $add[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br><br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить Поступление</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/Addmision/create.php" method="post">
      <p>ID Программы</p>
      <input type="text" name="ProgramID">
      <p>ID Специальность БНТУ</p>
      <textarea name="SpecialityBntuID"></textarea><br><br>
