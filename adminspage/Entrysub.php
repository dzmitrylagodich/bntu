...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $entrs = mysqli_query($conn, "SELECT * from `EntrySubjects`");
      $entrs = mysqli_fetch_all($entrs);
      ...
      <td>
          <a href="../updatefor/updateentrysub.php?EntrySubjectsID=<?= $entr[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/entrysub/delete.php?EntrySubjectsID=<?= $entr[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br><br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый встутпительный предмет</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/entrysub/create.php" method="post">
      <p>EntrySubjectsID</p>
      <input type="text" name="EntrySubjectsID">
      <p>Subjects</p>
      <textarea name="Subjects"></textarea><br><br>
