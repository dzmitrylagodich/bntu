...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $finances = mysqli_query($conn, "SELECT * from `Finance`");
      $finances = mysqli_fetch_all($finances);
      ...
      <td>
          <a href="../updatefor/updatefinance.php?MoneyID=<?= $finance[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/finance/delete.php?MoneyID=<?= $finance[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br> <br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новую финансовую структуру</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/finance/create.php" method="post">
      <p>ID</p>
      <input type="text" name="MoneyID">
      <p>Финансы</p>
      <textarea name="Finance"></textarea><br><br>
       <p>Цена</p>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("fintable");
    switching = true;
    while (switching) {
      switching = false;
