...
<div class="ssilki">
    ...
    <a style="margin-left: 20px;" class="pn" href="Formofed.php" class="active">Форма обучения</a>
...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $froms = mysqli_query($conn, "SELECT * from `FormOfEd`");
      $froms = mysqli_fetch_all($froms);
      ...
      <td>
          <a href="../updatefor/updateformofed.php?FormID=<?= $from[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/formofed/delete.php?FormID=<?= $from[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
...
<br> <br> 
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новую форму обучения</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/formofed/create.php" method="post">
      <p>ID</p>
      <input type="text" name="FormID">
      <p>Название</p>
      <textarea name="FormName"></textarea><br><br>
...
document.addEventListener("DOMContentLoaded", function() {
  var table = document.getElementById("formofedtable");
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("formofedtable");
    switching = true;
    while (switching) {
      switching = false;
