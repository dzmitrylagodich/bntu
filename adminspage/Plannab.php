...
<div class="ssilki">
    ...
    <a style="margin-left: 20px;" class="pn" href="Plannab.php" class="active">План набора прошлого года</a>
...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $plannabs = mysqli_query($conn, "SELECT * from `AdmissionPlanOfLastYear`");
      $plannabs = mysqli_fetch_all($plannabs);
      foreach ($plannabs as $plannab) {
        ?>
      <tr>
      <td>
          <?=$plannab[0] ?>
      ...
      <td>
          <a href="../updatefor/updateplannab.php?AdmissionPlanOfLastYearID=<?= $plannab[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/plannab/delete.php?AdmissionPlanOfLastYearID=<?= $plannab[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br>
  <br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый план набора </h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/plannab/create.php" method="post">
      <p>ID</p>
      <input type="text" name="AdmissionPlanOfLastYearID">
      <p>Год</p>
      <textarea name="admission_year"></textarea><br><br>
      <p>Баллы</p>
      <textarea name="Points"></textarea><br><br>
      <button type="submit" style="display: flex; justify-content: center; align-items: center;">Изменить</button>    
  </form>
  </div>
...
document.addEventListener("DOMContentLoaded", function() {
  var table = document.getElementById("plannabtable");
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("plannabtable");
    switching = true;
    while (switching) {
      switching = false;
      rows = table.rows;
