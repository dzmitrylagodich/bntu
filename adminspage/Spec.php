...
<div class="ssilki">
    ...
    <a style="margin-left: 20px;" class="pn" href="Spec.php" class="active">Специальности БНТУ</a>
...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $bntuspecs = mysqli_query($conn, "SELECT * from `SpecialityBntu`");
      $bntuspecs = mysqli_fetch_all($bntuspecs);
      foreach ($bntuspecs as $bntuspec) {
        ?>
      <tr>
      <td>
          <?=$bntuspec[0] ?>
      ...
      <td>
          <a href="../updatefor/updatespec.php?SpecialityBntuID=<?= $bntuspec[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/spec/delete.php?SpecialityBntuID=<?= $bntuspec[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новую Специальность БНТУ</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/spec/create.php" method="post">
      <p>SpecialityBntuID</p>
      <input type="text" name="SpecialityBntuID">
      <p>Название</p>
      ...
      <p>Вступительные предметы</p>
      <textarea name="EntrySubjectsID"></textarea><br><br>
      <p>Факультет</p>
      <textarea name="FakultetID"></textarea><br><br>
