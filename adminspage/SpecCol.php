...
<div class="ssilki">
    ...
    <a style="margin-left: 20px;" class="pn" href="SpecCol.php" class="active">Специальности колледжей</a>
...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $colegsps = mysqli_query($conn, "SELECT * from `СollegeSpecialties`");
      $colegsps = mysqli_fetch_all($colegsps);
      foreach ($colegsps as $colegsp) {
        ?>
      <tr>
      <td>
          <?=$colegsp[0] ?>
      ...
      <td>
          <a href="../updatefor/updatspeccol.php?collegeID=<?= $colegsp[0] ?>">Изменить</a>
      </td>  
      <td>
          <a href="../admin/speccol/delete.php?collegeID=<?= $colegsp[0] ?>">Удалить</a>
      </td>
      </tr>
  ...
  <br><br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый Специальность колледжа</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/speccol/create.php" method="post">
      <p>ID колледжа</p>
      <input type="text" name="collegeID">
      <p>ID программы</p>
      <input type="text" name="ProgramID"><br><br>
...
document.addEventListener("DOMContentLoaded", function() {
  var table = document.getElementById("speccoltable");
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("speccoltable");
    switching = true;
    while (switching) {
      switching = false;
      rows = table.rows;
