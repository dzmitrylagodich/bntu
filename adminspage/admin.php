...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      ...
      <td>
          <a href="../updatefor/update.php?ExamID=<?= $exam[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/delete.php?ExamID=<?= $exam[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br><br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый экзамен</h3>
  <br>
