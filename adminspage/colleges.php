...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $colegs = mysqli_query($conn, "SELECT * from `colleges`");
      $colegs = mysqli_fetch_all($colegs);
      foreach ($colegs as $coleg) {
        ?>
      <tr>
      <td>
          <?=$coleg[0] ?>
      ...
      <td>
          <a href="../updatefor/updatecolleges.php?collegeID=<?= $coleg[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/colleges/delete.php?collegeID=<?= $coleg[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <br><br>
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый Колледж</h3>
   <br>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/colleges/create.php" method="post">
      <p>CollegeID</p>
      <input type="text" name="collegeID">
      <p>Название</p>
      <textarea name="collegeName"></textarea><br><br>
      <p>Адрес</p>
      <textarea name="Adress"></textarea><br><br>
      <p>Директор</p>
      <textarea name="Director"></textarea><br><br>
      <p>Город</p>
      <textarea name="City"></textarea><br><br>
      <p>Телефон</p>
      <textarea name="tell"></textarea><br><br>
      <p>Почта</p>
...
document.addEventListener("DOMContentLoaded", function() {
  var table = document.getElementById("collegtable");
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("collegtable");
    switching = true;
    while (switching) {
      switching = false;
