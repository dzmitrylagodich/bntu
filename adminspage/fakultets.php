...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 50px;">
  ...
  <?php
      $fakults = mysqli_query($conn, "SELECT * from `Fakultet`");
      $fakults = mysqli_fetch_all($fakults);
      foreach ($fakults as $fakult) {
        ?>
      <tr>
      <td>
          <?=$fakult[0] ?>
      ...
      <td>
          <a href="../updatefor/updatefakult.php?FakultetID=<?= $fakult[0] ?>">Изменить</a>
      </td>
      <td>
          <a href="../admin/fakultets/delete.php?FakultetID=<?= $fakult[0] ?>">Удалить</a>
      </td>
      </tr>
  <?php
      }
  ...
  <h3 style="display: flex; align-items: center; justify-content: center;">Добавить новый факультет</h3>
  <div style="display: flex; align-items: center; justify-content: center;"> 
  <form action="../admin/fakultets/create.php" method="post">
      <p>FakultetID</p>
      <input type="text" name="FakultetID">
      <p>Название</p>
...
document.addEventListener("DOMContentLoaded", function() {
  var table = document.getElementById("fakulttable");
  ...
  function sortTable(columnIndex) {
    ...
    table = document.getElementById("fakulttable");
    switching = true;
    while (switching) {
      switching = false;
      rows = table.rows;
