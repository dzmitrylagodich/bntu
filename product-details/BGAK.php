...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg12">
          <h3>Бобруский Государственный Автотранспортный Колледж</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/BGAK.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>Бобруский Государственный Автотранспортный Колледж</h4>
          <p>Филиал БНТУ «Бобруйский государственный автотранспортный колледж» - одно из ведущих учреждений Республики Беларусь по подготовке специалистов для автотранспорта.</p>
          <ul>
            <li><span>Адрес:</span> г. Бобруйск, Интернациональная, 48</li>
            <li><span>Телефон:</span> +375 225 71 89 01(приемная комиссия)</li>
            <li><span>E-mail:</span> bgak@bntu.by</li>
            <li><span>Сайт:</span> <a href="#">bgak.bntu.by/colleges/bgak</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
