...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>БОРИСОВСКИЙ ГОСУДАРСТВЕННЫЙ ПОЛИТЕХНИЧЕСКИЙ КОЛЛЕДЖ</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/BGPK.jpg" width="300" height="200" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>БОРИСОВСКИЙ ГОСУДАРСТВЕННЫЙ ПОЛИТЕХНИЧЕСКИЙ КОЛЛЕДЖ</h4>
          <p>Филиал Белорусского национального технического университета (БНТУ) «Борисовский государственный политехнический колледж» является одним из ведущих учебных заведений в Республике Беларусь, специализирующихся на подготовке высококвалифицированных специалистов в области техники и технологий. Наш колледж предоставляет студентам широкий спектр образовательных программ, направленных на углубленное изучение инженерных наук и применение их в современной индустрии. Благодаря высокому уровню преподавательского состава и современной базе оборудования наши выпускники успешно реализуют себя в различных сферах промышленности и научных исследований, делая значительный вклад в технологический прогресс страны.</p>
          <ul>
            <li><span>Адрес:</span> г. Борисов, Гагарина, 68</li>
            <li><span>Телефон:</span> (8 0177) 74-46-36, 74-12-38, 74-25-78; 74-28-38 (приемная комиссия)</li>
            <li><span>E-mail:</span> bgpk@bntu.by</li>
            <li><span>Сайт:</span> <a href="#">bgpk.bntu.by</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
