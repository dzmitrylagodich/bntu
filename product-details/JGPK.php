...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>ЖЛОБИНСКИЙ ГОСУДАРСТВЕННЫЙ МЕТАЛЛУРГИЧЕСКИЙ КОЛЛЕДЖ</h3>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/jgpk.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>ЖЛОБИНСКИЙ ГОСУДАРСТВЕННЫЙ МЕТАЛЛУРГИЧЕСКИЙ КОЛЛЕДЖ</h4>
       
          <p>Жлобинский государственный металлургический колледж – это учреждение высшего образования, которое играет ключевую роль в подготовке квалифицированных специалистов для металлургической промышленности. Фокусируясь на современных методах обучения и передовых технологиях, наш колледж предоставляет студентам широкие возможности для приобретения глубоких знаний в области металлургии, металлообработки и смежных отраслей. Профессорско-преподавательский состав, состоящий из опытных специалистов, обеспечивает качественную подготовку студентов, что открывает перед ними перспективы для успешной карьеры в металлургической отрасли и смежных областях промышленности.</p>
            <ul>
            <li><span>Адрес:</span> г. Жлобин, Фоканова, 1а</li>
            <li><span>Телефон:</span> 8 (02334) 3-91-14 (приёмная комиссия), 3-91-05 (приёмная, директор)</li>
            <li><span>E-mail:</span> info@zmt.by</li>
            <li><span>Сайт:</span> <a href="#">zmt.by</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
