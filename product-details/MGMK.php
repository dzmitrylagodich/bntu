...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>МИНСКИЙ ГОСУДАРСТВЕННЫЙ МАШИНОСТРОИТЕЛЬНЫЙ КОЛЛЕДЖ</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/mgmk.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>МИНСКИЙ ГОСУДАРСТВЕННЫЙ МАШИНОСТРОИТЕЛЬНЫЙ КОЛЛЕДЖ</h4>
          
          <p>
            Минский государственный машиностроительный колледж – это учреждение, нацеленное на подготовку высококвалифицированных специалистов в области машиностроения и технических наук. Наш колледж предоставляет студентам современные образовательные программы, включающие в себя как теоретические знания, так и практические навыки, необходимые для успешной карьеры в промышленности. Профессиональный преподавательский состав и современное оборудование обеспечивают высокий уровень обучения, что позволяет нашим выпускникам успешно применять свои знания и навыки на практике и вносить значительный вклад в развитие отрасли машиностроения.
          </p>
            <ul>
            <li><span>Адрес:</span> г. Минск, Долгобродская, 25</li>
            <li><span>Телефон:</span> 8-017-398-95-39</li>
            <li><span>E-mail:</span> abitur-mgmk@bntu.by</li>
            <li><span>Сайт:</span> <a href="#">www.college.by</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
