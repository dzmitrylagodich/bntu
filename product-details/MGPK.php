...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>МИНСКИЙ ГОСУДАРСТВЕННЫЙ ПОЛИТЕХНИЧЕСКИЙ КОЛЛЕДЖ</h3>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/mgpk.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>МИНСКИЙ ГОСУДАРСТВЕННЫЙ ПОЛИТЕХНИЧЕСКИЙ КОЛЛЕДЖ</h4>
          <p>
            Минский государственный политехнический колледж – это ведущее учебное заведение, занимающееся подготовкой высококвалифицированных специалистов в области технических наук. Наш колледж предоставляет студентам широкий спектр образовательных программ, включающих как теоретические знания, так и практические навыки, необходимые для успешной карьеры в современной промышленности. Профессиональный преподавательский состав и современное оборудование обеспечивают высокий уровень обучения, что позволяет нашим выпускникам успешно реализовывать свой потенциал и вносить значительный вклад в технологический прогресс и инновации.
          </p>
            <ul>
            <li><span>Адрес:</span> г. Минск, пр-т Независимости, 85</li>
            <li><span>Телефон:</span> Приемная комиссия: (017) 260-85-32</li>
            <li><span>E-mail:</span> mgpk@bntu.by</li>
            <li><span>Сайт:</span> <a href="#">mgpk.bntu.by</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
