...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>СОЛИГОРСКИЙ ГОСУДАРСТВЕННЫЙ ГОРНО-ХИМИЧЕСКИЙ КОЛЛЕДЖ</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="../assets/coll/sgghk.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>СОЛИГОРСКИЙ ГОСУДАРСТВЕННЫЙ ГОРНО-ХИМИЧЕСКИЙ КОЛЛЕДЖ</h4>
          
          <p>
            Солигорский государственный горно-химический колледж - это ведущее учебное заведение, специализирующееся на подготовке специалистов в области горной и химической промышленности. Наш колледж предлагает студентам разнообразные образовательные программы, ориентированные на освоение современных технологий и методов работы в данных отраслях. Профессиональный преподавательский состав и современное оборудование позволяют обеспечить высокий уровень обучения и подготовки специалистов, способных успешно реализовывать свой потенциал в производстве и научных исследованиях, делая значительный вклад в развитие отрасли.
          </p>
            <ul>
            <li><span>Адрес:</span> г. Солигорск, Козлова, 18</li>
            <li><span>Телефон:</span> +375(174)23-66-01 (приёмная директора) +375(174)26-09-44 (приемная комиссия)
</li>
            <li><span>E-mail:</span> sgghc@bntu.by</li>
            <li><span>Сайт:</span> <a href="#">sgght.belhost.by</a></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
